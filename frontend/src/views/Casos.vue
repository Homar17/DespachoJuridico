          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div class="mt-8 pt-5 border-t border-white/5 flex justify-end">
                <button @click="router.push(`/caso/${caso.id}`)" class="text-despacho-tierra font-bold text-xs flex items-center gap-2 hover:text-despacho-rosa transition-colors group/btn">
                  DETALLES DEL CASO
